...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxd2ff9ea209f500d0'),         // AppID
    'secret'  => env('WECHAT_SECRET', ''),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'mingshaju'),          // Token
    ...
    'mock_user' => [
        'openid' => 'oVKg11YNU-XbtaPbC2P1yLvpjUD8', //'odh7zsgI75iT8FRh0fGlSojc9PWM',
